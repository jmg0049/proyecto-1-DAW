...
public class CtgLacteos extends JFrame {
	...
	public CtgLacteos() {
		...
		Cestas.setIcon(new ImageIcon(CtgLacteos.class.getResource("/Imagenes/MegaMarket.png")));
		...
		Condimentos.add(Miel);
			...
			ImagenAceite_Palma.setIcon(new ImageIcon(CtgLacteos.class.getResource("/Imagenes/leche desnatada.png")));
			...
			ImagenAceite_Girasol.setIcon(new ImageIcon(CtgLacteos.class.getResource("/Imagenes/leche entera.png")));
			...
			ImagenAceite_Oliva.setIcon(new ImageIcon(CtgLacteos.class.getResource("/Imagenes/leche semidesnatada.png")));
			...
			ImagenAceitunas_Negras.setIcon(new ImageIcon(CtgLacteos.class.getResource("/Imagenes/mantequilla con sal.png")));
			...
			ImagenAceitunas_Verdes.setIcon(new ImageIcon(CtgLacteos.class.getResource("/Imagenes/mantequilla sin sal.png")));
			...
			ImagenAjo_Blanco.setIcon(new ImageIcon(CtgLacteos.class.getResource("/Imagenes/queso de cabra.png")));
			...
			ImagenAjo_Morado.setIcon(new ImageIcon(CtgLacteos.class.getResource("/Imagenes/queso curado.png")));
			...
			ImagenAlmejas.setIcon(new ImageIcon(CtgLacteos.class.getResource("/Imagenes/queso fresco.png")));
			...
			ImagenAlmendras.setIcon(new ImageIcon(CtgLacteos.class.getResource("/Imagenes/queso de oveja.png")));
			...
			ImagenAlubias_Blancas.setIcon(new ImageIcon(CtgLacteos.class.getResource("/Imagenes/queso viejo.png")));
