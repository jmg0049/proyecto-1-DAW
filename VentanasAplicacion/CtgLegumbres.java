...
public class CtgLegumbres extends JFrame {
	...
	public CtgLegumbres() {
		...
		Cestas.setIcon(new ImageIcon(CtgLegumbres.class.getResource("/Imagenes/MegaMarket.png")));
		...
		Condimentos.add(Miel);
			...
			ImagenAceite_Palma.setIcon(new ImageIcon(CtgLegumbres.class.getResource("/Imagenes/Alubia blancas.png")));
			...
			ImagenAceite_Girasol.setIcon(new ImageIcon(CtgLegumbres.class.getResource("/Imagenes/Alubias negras.png")));
			...
			ImagenAceite_Oliva.setIcon(new ImageIcon(CtgLegumbres.class.getResource("/Imagenes/Alubias rojas.png")));
			...
			ImagenAceitunas_Negras.setIcon(new ImageIcon(CtgLegumbres.class.getResource("/Imagenes/alubias verdes.png")));
			...
			ImagenAceitunas_Verdes.setIcon(new ImageIcon(CtgLegumbres.class.getResource("/Imagenes/garbanzos.png")));
			...
			ImagenAjo_Blanco.setIcon(new ImageIcon(CtgLegumbres.class.getResource("/Imagenes/guisantes.png")));
			...
			ImagenAjo_Morado.setIcon(new ImageIcon(CtgLegumbres.class.getResource("/Imagenes/lentejas.png")));
