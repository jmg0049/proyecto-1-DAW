...
public class CtgFrutas extends JFrame {
	...
	public CtgFrutas() {
		...
		Cestas.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/MegaMarket.png")));
		...
		Condimentos.add(Miel);
			...
			ImagenAceite_Palma.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/Aceituna negra.png")));
			...
			ImagenAceite_Girasol.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/Aceitunas verdes.png")));
			...
			ImagenAceite_Oliva.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/cerezas.png")));
			...
			ImagenAceitunas_Negras.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/coco marrón.png")));
			...
			ImagenAceitunas_Verdes.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/coco verde.png")));
			...
			ImagenAjo_Blanco.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/fresas.png")));
			...
			ImagenAjo_Morado.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/mandarina.png")));
			...
			ImagenAlmejas.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/manzana amarilla.png")));
			...
			ImagenAlmendras.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/Manzana_Roja.png")));
			...
			ImagenAlubias_Blancas.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/Manzana_Verde.png")));
			...
			ImagenAlubias_Negras.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/Melon_Amarillo.png")));
			...
			ImagenAlubias_Rojas.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/Melon_Blanca.png")));
			...
			ImagenAlubias_Verdes.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/Melon_Verde.png")));
			...
			ImagenAnacardos.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/peras amarillas.png")));
			...
			ImagenAngulas.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/peras.png")));
			...
			ImagenAvellanas.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/platano.png")));
			...
			ImagenAzucar_Blanco.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/sandia.png")));
			...
			ImagenAzucar_Glas.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/uvas moradas.png")));
			...
			ImagenAzucar_Moreno.setIcon(new ImageIcon(CtgFrutas.class.getResource("/Imagenes/uvas verdes.png")));
