...
public class CtgMarisco extends JFrame {
	...
	public CtgMarisco() {
		...
		Cestas.setIcon(new ImageIcon(CtgMarisco.class.getResource("/Imagenes/MegaMarket.png")));
		...
		Condimentos.add(Miel);
			...
			ImagenAceite_Palma.setIcon(new ImageIcon(CtgMarisco.class.getResource("/Imagenes/almejas.png")));
			...
			ImagenAceite_Girasol.setIcon(new ImageIcon(CtgMarisco.class.getResource("/Imagenes/bogavante.png")));
			...
			ImagenAceite_Oliva.setIcon(new ImageIcon(CtgMarisco.class.getResource("/Imagenes/calamares.png")));
			...
			ImagenAceitunas_Negras.setIcon(new ImageIcon(CtgMarisco.class.getResource("/Imagenes/calamar troceado.png")));
			...
			ImagenAceitunas_Verdes.setIcon(new ImageIcon(CtgMarisco.class.getResource("/Imagenes/cangrejo.png")));
			...
			ImagenAjo_Blanco.setIcon(new ImageIcon(CtgMarisco.class.getResource("/Imagenes/gambas.png")));
			...
			ImagenAjo_Morado.setIcon(new ImageIcon(CtgMarisco.class.getResource("/Imagenes/langosta.png")));
			...
			ImagenAlmejas.setIcon(new ImageIcon(CtgMarisco.class.getResource("/Imagenes/langostinos.png")));
			...
			ImagenAlmendras.setIcon(new ImageIcon(CtgMarisco.class.getResource("/Imagenes/Mejillones.png")));
			...
			ImagenAlubias_Blancas.setIcon(new ImageIcon(CtgMarisco.class.getResource("/Imagenes/pulpo entero.png")));
			...
			ImagenAlubias_Negras.setIcon(new ImageIcon(CtgMarisco.class.getResource("/Imagenes/pulpo troceado.png")));
			...
			ImagenAlubias_Rojas.setIcon(new ImageIcon(CtgMarisco.class.getResource("/Imagenes/sepia entera.png")));
			...
			ImagenAlubias_Verdes.setIcon(new ImageIcon(CtgMarisco.class.getResource("/Imagenes/sepia troceada.png")));
