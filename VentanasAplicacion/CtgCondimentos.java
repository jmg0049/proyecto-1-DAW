...
public class CtgCondimentos extends JFrame {
	...
	public CtgCondimentos() {
		...
		JButton SumBjenas = new JButton("+1");
		SumBjenas.setBounds(1625, 430, 55, 23);
		contentPane.add(SumBjenas);
		
		JButton ResBejenas = new JButton("-1");
		ResBejenas.setBounds(1690, 430, 55, 23);
		contentPane.add(ResBejenas);
		...
		Cestas.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/MegaMarket.png")));
		...
		Condimentos.add(Miel);
			...
			LabelAzucar_blanco.setBounds(40, 126, 104, 14);
			contentPane.add(LabelAzucar_blanco);
			
			JLabel ImagenAzucar_blanco = new JLabel(" ");
			ImagenAzucar_blanco.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/Azucar blanco.png")));
			ImagenAzucar_blanco.setBounds(40, 126, 91, 111);
			contentPane.add(ImagenAzucar_blanco);
			
			JLabel LabelAzucar_glass = new JLabel("Azúcar glass");
			LabelAzucar_glass.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelAzucar_glass.setBounds(200, 126, 104, 14);
			contentPane.add(LabelAzucar_glass);
			
			JLabel ImagenAzucar_glass = new JLabel(" ");
			ImagenAzucar_glass.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/Azúcar glass.png")));
			ImagenAzucar_glass.setBounds(200, 126, 91, 111);
			contentPane.add(ImagenAzucar_glass);
			
			JLabel LabelAzucar_moreno = new JLabel("Azúcar moreno");
			LabelAzucar_moreno.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelAzucar_moreno.setBounds(360, 126, 104, 14);
			contentPane.add(LabelAzucar_moreno);
			
			JLabel ImagenAzucar_moreno = new JLabel(" ");
			ImagenAzucar_moreno.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/Azúcar moreno.png")));
			ImagenAzucar_moreno.setBounds(360, 126, 91, 111);
			contentPane.add(ImagenAzucar_moreno);
			
			JLabel LabelCanela_en_barra = new JLabel("Canela en barra");
			LabelCanela_en_barra.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelCanela_en_barra.setBounds(520, 126, 104, 14);
			contentPane.add(LabelCanela_en_barra);
			
			JLabel ImagenCanela_en_barra = new JLabel(" ");
			ImagenCanela_en_barra.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/canela en barra.png")));
			ImagenCanela_en_barra.setBounds(520, 126, 91, 111);
			contentPane.add(ImagenCanela_en_barra);
			
			JLabel LabelCanela_molida = new JLabel("Canela molida");
			LabelCanela_molida.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelCanela_molida.setBounds(680, 126, 104, 14);
			contentPane.add(LabelCanela_molida);
			
			JLabel ImagenCanela_molida = new JLabel(" ");
			ImagenCanela_molida.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/canela molida.png")));
			ImagenCanela_molida.setBounds(680, 126, 91, 111);
			...
			LabelComino_molido.setBounds(840, 126, 104, 14);
			contentPane.add(LabelComino_molido);
			
			JLabel ImagenComino_molido = new JLabel(" ");
			ImagenComino_molido.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/comino molido.png")));
			ImagenComino_molido.setBounds(840, 126, 91, 111);
			...
			LabelJengibre_molido.setBounds(1000, 126, 104, 14);
			contentPane.add(LabelJengibre_molido);
			
			JLabel ImagenJengibre_molido = new JLabel(" ");
			ImagenJengibre_molido.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/jengibre molido.png")));
			ImagenJengibre_molido.setBounds(1000, 126, 91, 111);
			contentPane.add(ImagenJengibre_molido);
			
			JLabel LabelHojas_de_oregano = new JLabel("Hojas de orégano");
			LabelHojas_de_oregano.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelHojas_de_oregano.setBounds(1160, 126, 104, 14);
			contentPane.add(LabelHojas_de_oregano);
			
			JLabel ImagenHojas_de_oregano = new JLabel(" ");
			ImagenHojas_de_oregano.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/Hojas de orégano.png")));
			ImagenHojas_de_oregano.setBounds(1160, 126, 91, 111);
			contentPane.add(ImagenHojas_de_oregano);
			
			JLabel LabelHojas_de_perejil = new JLabel("Hojas de perejil");
			LabelHojas_de_perejil.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelHojas_de_perejil.setBounds(1320, 126, 104, 14);
			contentPane.add(LabelHojas_de_perejil);
			
			JLabel ImagenHojas_de_perejil = new JLabel(" ");
			ImagenHojas_de_perejil.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/hojas de perejil.png")));
			ImagenHojas_de_perejil.setBounds(1320, 126, 91, 111);
			contentPane.add(ImagenHojas_de_perejil);
						
			JLabel LabelMiel_Dulce = new JLabel("Miel Dulce");
			LabelMiel_Dulce.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelMiel_Dulce.setBounds(1480, 126, 104, 14);
			contentPane.add(LabelMiel_Dulce);
			
			JLabel ImagenMiel_Dulce = new JLabel(" ");
			ImagenMiel_Dulce.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/Miel_Dulce.png")));
			ImagenMiel_Dulce.setBounds(1480, 126, 91, 111);
			...
			LabelMiel_Melaza.setBounds(1640, 126, 104, 14);
			contentPane.add(LabelMiel_Melaza);
			
			JLabel ImagenMiel_Melaza = new JLabel(" ");
			ImagenMiel_Melaza.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/Miel_Melaza.png")));
			ImagenMiel_Melaza.setBounds(1640, 126, 91, 111);
			contentPane.add(ImagenMiel_Melaza);
			
			JLabel LabelOregano_molido = new JLabel("Oregano molido");
			LabelOregano_molido.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelOregano_molido.setBounds(1800, 126, 104, 14);
			contentPane.add(LabelOregano_molido);
			
			JLabel ImagenOregano_molido = new JLabel(" ");
			ImagenOregano_molido.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/orégano molido.png")));
			ImagenOregano_molido.setBounds(1800, 126, 91, 111);
			...
			LabelPerejil_molido.setBounds(40, 306, 104, 14);
			contentPane.add(LabelPerejil_molido);
			
			JLabel ImagenPerejil_molido = new JLabel(" ");
			ImagenPerejil_molido.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/perejil molido.png")));
			ImagenPerejil_molido.setBounds(40, 306, 91, 111);
			contentPane.add(ImagenPerejil_molido);
						
			JLabel LabelPimenton_ahumado = new JLabel("Pimentón ahumado");
			LabelPimenton_ahumado.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelPimenton_ahumado.setBounds(200, 306, 104, 14);
			contentPane.add(LabelPimenton_ahumado);
			
			JLabel ImagenPimenton_ahumado = new JLabel(" ");
			ImagenPimenton_ahumado.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/pimenton ahumado.png")));
			ImagenPimenton_ahumado.setBounds(200, 306, 91, 111);
			contentPane.add(ImagenPimenton_ahumado);
									
			JLabel LabelPimenton_dulce = new JLabel("Pimentón dulce");
			LabelPimenton_dulce.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelPimenton_dulce.setBounds(360, 306, 104, 14);
			contentPane.add(LabelPimenton_dulce);
			
			JLabel ImagenPimenton_dulce = new JLabel(" ");
			ImagenPimenton_dulce.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/pimenton dulce.png")));
			ImagenPimenton_dulce.setBounds(360, 306, 91, 111);
			contentPane.add(ImagenPimenton_dulce);
			
			JLabel LabelPimienta_negra = new JLabel("Pimienta negra");
			LabelPimienta_negra.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelPimienta_negra.setBounds(520, 306, 104, 14);
			contentPane.add(LabelPimienta_negra);
			
			JLabel ImagenPimienta_negra = new JLabel(" ");
			ImagenPimienta_negra.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/pimienta negra.png")));
			ImagenPimienta_negra.setBounds(520, 306, 91, 111);
			...
			LabelPimienta_roja.setBounds(680, 306, 104, 14);
			contentPane.add(LabelPimienta_roja);
			
			JLabel ImagenPimienta_roja = new JLabel(" ");
			ImagenPimienta_roja.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/pimienta roja.png")));
			ImagenPimienta_roja.setBounds(680, 306, 91, 111);
			contentPane.add(ImagenPimienta_roja);
									
			JLabel LabelRaiz_de_jengibre = new JLabel("Raiz de jengibre");
			LabelRaiz_de_jengibre.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelRaiz_de_jengibre.setBounds(840, 306, 104, 14);
			contentPane.add(LabelRaiz_de_jengibre);
			
			JLabel ImagenRaiz_de_jengibre = new JLabel(" ");
			ImagenRaiz_de_jengibre.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/raiz de jengibre.png")));
			ImagenRaiz_de_jengibre.setBounds(840, 306, 91, 111);
			contentPane.add(ImagenRaiz_de_jengibre);
			
			JLabel LabelSal_fina = new JLabel("Sal fina");
			LabelSal_fina.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelSal_fina.setBounds(1000, 306, 104, 14);
			contentPane.add(LabelSal_fina);
			
			JLabel ImagenSal_fina = new JLabel(" ");
			ImagenSal_fina.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/sal fina.png")));
			ImagenSal_fina.setBounds(1000, 306, 91, 111);
			...
			LabelSal_gruesa.setBounds(1160, 306, 104, 14);
			contentPane.add(LabelSal_gruesa);
			
			JLabel ImagenSal_gruesa = new JLabel(" ");
			ImagenSal_gruesa.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/sal gruesa.png")));
			ImagenSal_gruesa.setBounds(1160, 306, 91, 111);
			...
			LabelVinagre_blanco.setBounds(1320, 306, 104, 14);
			contentPane.add(LabelVinagre_blanco);
			
			JLabel ImagenVinagre_blanco = new JLabel(" ");
			ImagenVinagre_blanco.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/vinagre blanco.png")));
			ImagenVinagre_blanco.setBounds(1320, 306, 91, 111);
			contentPane.add(ImagenVinagre_blanco);
			
			JLabel LabelVinagre_de_sidra = new JLabel("Vinagre de sidra");
			LabelVinagre_de_sidra.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelVinagre_de_sidra.setBounds(1480, 306, 104, 14);
			contentPane.add(LabelVinagre_de_sidra);
			
			JLabel ImagenVinagre_de_sidra = new JLabel(" ");
			ImagenVinagre_de_sidra.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/vinagre de sidra.png")));
			ImagenVinagre_de_sidra.setBounds(1480, 306, 91, 111);
			contentPane.add(ImagenVinagre_de_sidra);
			
			JLabel LabelVinagre_de_vino = new JLabel("Vinagre de vino");
			LabelVinagre_de_vino.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelVinagre_de_vino.setBounds(1640, 306, 104, 14);
			contentPane.add(LabelVinagre_de_vino);
			
			JLabel ImagenVinagre_de_vino = new JLabel(" ");
			ImagenVinagre_de_vino.setIcon(new ImageIcon(CtgCondimentos.class.getResource("/Imagenes/vinagre de vino.png")));
			ImagenVinagre_de_vino.setBounds(1640, 306, 91, 111);
			contentPane.add(ImagenVinagre_de_vino);
			...
			JLabel lblNewLabel_1_345_6 = new JLabel("precio");
			lblNewLabel_1_345_6.setHorizontalAlignment(SwingConstants.CENTER);
			lblNewLabel_1_345_6.setBounds(1640, 415, 46, 14);
			contentPane.add(lblNewLabel_1_345_6);
			...
			JLabel lblNewLabel_2_550 = new JLabel("Peso kg");
			lblNewLabel_2_550.setBounds(1690, 415, 46, 14);
			contentPane.add(lblNewLabel_2_550);
