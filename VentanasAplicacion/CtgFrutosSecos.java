...
public class CtgFrutosSecos extends JFrame {
	...
	public CtgFrutosSecos() {
		...
		Cestas.setIcon(new ImageIcon(CtgFrutosSecos.class.getResource("/Imagenes/MegaMarket.png")));
		...
		Condimentos.add(Miel);
			...
			ImagenAceite_Palma.setIcon(new ImageIcon(CtgFrutosSecos.class.getResource("/Imagenes/almendras.png")));
			...
			ImagenAceite_Girasol.setIcon(new ImageIcon(CtgFrutosSecos.class.getResource("/Imagenes/Anacardos.png")));
			...
			ImagenAceite_Oliva.setIcon(new ImageIcon(CtgFrutosSecos.class.getResource("/Imagenes/Avellanas.png")));
			...
			ImagenAceitunas_Negras.setIcon(new ImageIcon(CtgFrutosSecos.class.getResource("/Imagenes/cacahuetes.png")));
			...
			ImagenAceitunas_Verdes.setIcon(new ImageIcon(CtgFrutosSecos.class.getResource("/Imagenes/castañas.png")));
			ImagenAceitunas_Verdes.setBounds(665, 126, 91, 111);
			...
			ImagenAjo_Blanco.setIcon(new ImageIcon(CtgFrutosSecos.class.getResource("/Imagenes/kikos.png")));
			...
			ImagenAjo_Morado.setIcon(new ImageIcon(CtgFrutosSecos.class.getResource("/Imagenes/Nueces.png")));
			...
			ImagenAlmejas.setIcon(new ImageIcon(CtgFrutosSecos.class.getResource("/Imagenes/pasas.png")));
			...
			ImagenAlmendras.setIcon(new ImageIcon(CtgFrutosSecos.class.getResource("/Imagenes/pipas calabaza.png")));
			...
			ImagenAlubias_Blancas.setIcon(new ImageIcon(CtgFrutosSecos.class.getResource("/Imagenes/pipas.png")));
			...
			ImagenAlubias_Negras.setIcon(new ImageIcon(CtgFrutosSecos.class.getResource("/Imagenes/pistachos.png")));
