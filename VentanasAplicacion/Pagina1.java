...
public class Pagina1 extends JFrame {
	...
	public Pagina1() {
		...
		Cestas.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/MegaMarket.png")));
		...
		Productos_Animales.setBackground(new Color(255, 128, 128));
		...
		Condimentos.add(Miel);
			...
			ImagenAceite_Palma.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/aceite de palma.png")));
			...
			ImagenAceite_Girasol.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/Aceite de girasol.png")));
			...
			ImagenAceite_Oliva.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/aceite de oliva.png")));
			...
			ImagenAceitunas_Negras.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/Aceituna negra.png")));
			...
			ImagenAceitunas_Verdes.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/Aceitunas verdes.png")));
			...
			ImagenAjo_Blanco.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/ajo blanco.png")));
			...
			ImagenAjo_Morado.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/Ajo morado.png")));
			...
			ImagenAlmejas.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/almejas.png")));
			...
			ImagenAlmendras.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/almendras.png")));
			...
			ImagenAlubias_Blancas.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/Alubia blancas.png")));
			...
			ImagenAlubias_Negras.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/Alubias negras.png")));
			...
			ImagenAlubias_Rojas.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/Alubias rojas.png")));
			...
			ImagenAlubias_Verdes.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/alubias verdes.png")));
			...
			ImagenAnacardos.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/Anacardos.png")));
			...
			ImagenAngulas.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/Angulas.png")));
			...
			ImagenAvellanas.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/Avellanas.png")));
			...
			ImagenAzucar_Blanco.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/Azucar blanco.png")));
			...
			ImagenAzucar_Glas.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/Azúcar glass.png")));
			...
			ImagenAzucar_Moreno.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/Azúcar moreno.png")));
			...
			ImagenBacalao_Troceado.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/Bacalao troceado.png")));
			...
			ImagenBeicon.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/beicon.png")));
			...
			ImagenBerenjenas.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/berenjenas.png")));
			...
			ImagenBogavante.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/bogavante.png")));
			...
			ImagenBrocoli.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/brocoli.png")));
			...
			ImagenCaballa_Troceada.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/caballa troceada.png")));
			...
			ImagenCacahuetes.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/cacahuetes.png")));
			...
			ImagenCalamar_Entero.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/calamares.png")));
			...
			ImagenCalamar_Troceado.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/calamar troceado.png")));
			...
			ImagenCanela_Barra.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/canela en barra.png")));
			...
			ImagenCanela_Molida.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/canela molida.png")));
			...
			ImagenCangrejo.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/cangrejo.png")));
			...
			ImagenCana_Lomo.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/caña de lomo.png")));
			...
			ImagenCarne_Picada_Cerdo.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/carne picada de cerdo.png")));
			...
			ImagenCarne_Picada_Pavo.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/carne picada de pavo.png")));
			...
			ImagenCarne_Picada_Pollo.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/carne picada de pollo.png")));
			...
			ImagenCarne_Picada_Ternera.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/carne picada de ternera.png")));
			...
			ImagenCastanas.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/castañas.png")));
			...
			ImagenCazon_Troceado.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/cazón troceado.png")));
			...
			ImagenCebolla_Blanca.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/cebolla blanca.png")));
			...
			ImagenCebolla_Morada.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/cebolla morada.png")));
			...
			ImagenCerezas.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/cerezas.png")));
			...
			ImagenChorizo_Dulce.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/chorizo dulce.png")));
			...
			ImagenChorizo_Picante.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/chorizo picante.png")));
			...
			ImagenChuleta_Cerdo.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/chuleta de cerdo.png")));
			...
			ImagenChuleta_Cordero.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/chuleta de cordero.png")));
			...
			ImagenChuleta_Ternera.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/chuleta de ternera.png")));
			...
			ImagenCoco_Marron.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/coco marrón.png")));
			...
			ImagenCoco_Verde.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/coco verde.png")));
			...
			ImagenColiflor.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/coliflor.png")));
			...
			ImagenComino_Molido.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/comino molido.png")));
			...
			ImagenCostillas_Cerdo.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/costillas de cerdo.png")));
			...
			ImagenFilete_Bacalao.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/filete de bacalao.png")));
			...
			ImagenFilete_Caballa.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/filete de caballa.png")));
			...
			ImagenFilete_Cazon.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/filete de cazón.png")));
			...
			ImagenFilete_Cerdo.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/filete de cerdo.png")));
			ImagenFilete_Cerdo.setBounds(1000, 846, 91, 111);
			contentPane.add(ImagenFilete_Cerdo);
			
			JLabel LabelFilete_Cordero = new JLabel("Filete Cordero");
			LabelFilete_Cordero.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelFilete_Cordero.setBounds(1160, 846, 104, 14);
			contentPane.add(LabelFilete_Cordero);
			
			JLabel ImagenFilete_Cordero = new JLabel(" ");
			ImagenFilete_Cordero.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/filete de cordero.png")));
			ImagenFilete_Cordero.setBounds(1160, 846, 91, 111);
			contentPane.add(ImagenFilete_Cordero);
			
			JLabel LabelFilete_Merluza = new JLabel("Filete Merluza");
			LabelFilete_Merluza.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelFilete_Merluza.setBounds(1320, 846, 104, 14);
			contentPane.add(LabelFilete_Merluza);
			
			JLabel ImagenFilete_Merluza = new JLabel(" ");
			ImagenFilete_Merluza.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/filete de merluza.png")));
			ImagenFilete_Merluza.setBounds(1320, 846, 91, 111);
			contentPane.add(ImagenFilete_Merluza);
			
			JLabel LabelFilete_Pavo = new JLabel("Filete Pavo");
			LabelFilete_Pavo.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelFilete_Pavo.setBounds(1480, 846, 104, 14);
			contentPane.add(LabelFilete_Pavo);
			
			JLabel ImagenFilete_Pavo = new JLabel(" ");
			ImagenFilete_Pavo.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/filete de pavo.png")));
			ImagenFilete_Pavo.setBounds(1480, 846, 91, 111);
			contentPane.add(ImagenFilete_Pavo);
			
			JLabel LabelFilete_Pollo = new JLabel("Filete Pollo");
			LabelFilete_Pollo.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelFilete_Pollo.setBounds(1640, 846, 104, 14);
			contentPane.add(LabelFilete_Pollo);
			
			JLabel ImagenFilete_Pollo = new JLabel(" ");
			ImagenFilete_Pollo.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/filete de pollo.png")));
			ImagenFilete_Pollo.setBounds(1640, 846, 91, 111);
			contentPane.add(ImagenFilete_Pollo);
			
			JLabel LabelFilete_Salmon = new JLabel("Filete Salmón");
			LabelFilete_Salmon.setFont(new Font("Yu Gothic", Font.BOLD, 11));
			LabelFilete_Salmon.setBounds(1800, 846, 104, 14);
			contentPane.add(LabelFilete_Salmon);							
			
			JLabel ImagenFilete_Salmon = new JLabel(" ");
			ImagenFilete_Salmon.setIcon(new ImageIcon(Pagina1.class.getResource("/Imagenes/filete de salmón.png")));
			ImagenFilete_Salmon.setBounds(1800, 846, 91, 111);
			contentPane.add(ImagenFilete_Salmon);						
