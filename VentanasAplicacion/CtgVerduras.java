...
public class CtgVerduras extends JFrame {
	...
	public CtgVerduras() {
		...
		Cestas.setIcon(new ImageIcon(CtgVerduras.class.getResource("/Imagenes/MegaMarket.png")));
		...
		Condimentos.add(Miel);
			...
			ImagenAceite_Palma.setIcon(new ImageIcon(CtgVerduras.class.getResource("/Imagenes/ajo blanco.png")));
			...
			ImagenAceite_Girasol.setIcon(new ImageIcon(CtgVerduras.class.getResource("/Imagenes/Ajo morado.png")));
			...
			ImagenAceite_Oliva.setIcon(new ImageIcon(CtgVerduras.class.getResource("/Imagenes/berenjenas.png")));
			...
			ImagenAceitunas_Negras.setIcon(new ImageIcon(CtgVerduras.class.getResource("/Imagenes/brocoli.png")));
			...
			ImagenAceitunas_Verdes.setIcon(new ImageIcon(CtgVerduras.class.getResource("/Imagenes/cebolla blanca.png")));
			...
			ImagenAjo_Blanco.setIcon(new ImageIcon(CtgVerduras.class.getResource("/Imagenes/cebolla morada.png")));
			...
			ImagenAjo_Morado.setIcon(new ImageIcon(CtgVerduras.class.getResource("/Imagenes/coliflor.png")));
			...
			ImagenAlmejas.setIcon(new ImageIcon(CtgVerduras.class.getResource("/Imagenes/lechuga.png")));
			...
			ImagenAlmendras.setIcon(new ImageIcon(CtgVerduras.class.getResource("/Imagenes/Patatas.png")));
			...
			ImagenAlubias_Blancas.setIcon(new ImageIcon(CtgVerduras.class.getResource("/Imagenes/pimiento amarillo.png")));
			...
			ImagenAlubias_Negras.setIcon(new ImageIcon(CtgVerduras.class.getResource("/Imagenes/pimiento rojo.png")));
			...
			ImagenAlubias_Rojas.setIcon(new ImageIcon(CtgVerduras.class.getResource("/Imagenes/pimiento verde.png")));
			...
			ImagenAlubias_Verdes.setIcon(new ImageIcon(CtgVerduras.class.getResource("/Imagenes/puerro corto.png")));
			...
			ImagenAnacardos.setIcon(new ImageIcon(CtgVerduras.class.getResource("/Imagenes/puerro largo.png")));
			...
			ImagenAngulas.setIcon(new ImageIcon(CtgVerduras.class.getResource("/Imagenes/zanahorias.png")));
