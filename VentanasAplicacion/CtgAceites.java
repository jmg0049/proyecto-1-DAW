...
public class CtgAceites extends JFrame {
	...
	public CtgAceites() {
		...
		Cestas.setIcon(new ImageIcon(CtgAceites.class.getResource("/Imagenes/MegaMarket.png")));
		...
		Condimentos.add(Miel);
			...
			ImagenAceite_Palma.setIcon(new ImageIcon(CtgAceites.class.getResource("/Imagenes/aceite de palma.png")));
			...
			ImagenAceite_Girasol.setIcon(new ImageIcon(CtgAceites.class.getResource("/Imagenes/Aceite de girasol.png")));
			...
			ImagenAceite_Oliva.setIcon(new ImageIcon(CtgAceites.class.getResource("/Imagenes/aceite de oliva.png")));
