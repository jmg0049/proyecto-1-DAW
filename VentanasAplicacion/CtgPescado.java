...
public class CtgPescado extends JFrame {
	...
	public CtgPescado() {
		...
		Cestas.setIcon(new ImageIcon(CtgPescado.class.getResource("/Imagenes/MegaMarket.png")));
		...
		Condimentos.add(Miel);
			...
			ImagenAceite_Palma.setIcon(new ImageIcon(CtgPescado.class.getResource("/Imagenes/Angulas.png")));
			...
			ImagenAceite_Girasol.setIcon(new ImageIcon(CtgPescado.class.getResource("/Imagenes/Bacalao troceado.png")));
			...
			ImagenAceite_Oliva.setIcon(new ImageIcon(CtgPescado.class.getResource("/Imagenes/caballa troceada.png")));
			...
			ImagenAceitunas_Negras.setIcon(new ImageIcon(CtgPescado.class.getResource("/Imagenes/cazón troceado.png")));
			...
			ImagenAceitunas_Verdes.setIcon(new ImageIcon(CtgPescado.class.getResource("/Imagenes/filete de bacalao.png")));
			...
			ImagenAjo_Blanco.setIcon(new ImageIcon(CtgPescado.class.getResource("/Imagenes/filete de caballa.png")));
			...
			ImagenAjo_Morado.setIcon(new ImageIcon(CtgPescado.class.getResource("/Imagenes/filete de cazón.png")));
			...
			ImagenAlmejas.setIcon(new ImageIcon(CtgPescado.class.getResource("/Imagenes/filete de merluza.png")));
			...
			ImagenAlmendras.setIcon(new ImageIcon(CtgPescado.class.getResource("/Imagenes/filete de salmón.png")));
			...
			ImagenAlubias_Blancas.setIcon(new ImageIcon(CtgPescado.class.getResource("/Imagenes/lenguado.png")));
			...
			ImagenAlubias_Negras.setIcon(new ImageIcon(CtgPescado.class.getResource("/Imagenes/Merluza_trozeada.png")));
			...
			ImagenAlubias_Rojas.setIcon(new ImageIcon(CtgPescado.class.getResource("/Imagenes/rape.png")));
			...
			ImagenAlubias_Verdes.setIcon(new ImageIcon(CtgPescado.class.getResource("/Imagenes/salmon troceado.png")));
			...
			ImagenAnacardos.setIcon(new ImageIcon(CtgPescado.class.getResource("/Imagenes/sardinas.png")));
